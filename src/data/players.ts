...
export const players: Player[] = [
  ...
  { id: 'iker-casillas', name: 'Iker Casillas', level: 2, clubs: ['Real Madrid', 'Porto'] },
  ...
  { id: 'kylian-mbappe', name: 'Kylian Mbappe', level: 1, clubs: ['Monaco', 'Paris Saint-Germain', 'Real Madrid'] },
  { id: 'jude-bellingham', name: 'Jude Bellingham', level: 1, clubs: ['Birmingham City', 'Borussia Dortmund', 'Real Madrid'] },
  { id: 'vinicius-junior', name: 'Vinicius Junior', level: 1, clubs: ['Flamengo', 'Real Madrid'] },
  { id: 'mohamed-salah', name: 'Mohamed Salah', level: 1, clubs: ['Al-Mokawloon', 'Basel', 'Chelsea', 'Fiorentina', 'Roma', 'Liverpool'] },
  { id: 'bukayo-saka', name: 'Bukayo Saka', level: 2, clubs: ['Arsenal'] },
