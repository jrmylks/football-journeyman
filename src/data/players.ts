...
export const players: Player[] = [
  ...
  { id: 'gabriel-batistuta', name: 'Gabriel Batistuta', level: 1, clubs: ['Newell\'s Old Boys', 'River Plate', 'Boca Juniors', 'Fiorentina', 'Roma', 'Inter Milan', 'Al-Arabi'] },
  { id: 'del-piero', name: 'Alessandro Del Piero', level: 1, clubs: ['Padova', 'Juventus', 'Sydney FC', 'Delhi Dynamos'] },
  { id: 'raul', name: 'Raul', level: 1, clubs: ['Real Madrid', 'Schalke 04', 'Al Sadd', 'New York Cosmos'] },
  { id: 'hernan-crespo', name: 'Hernan Crespo', level: 2, clubs: ['River Plate', 'Parma', 'Lazio', 'Inter Milan', 'Chelsea', 'AC Milan', 'Inter Milan', 'Genoa', 'Parma'] },
  { id: 'fabio-cannavaro', name: 'Fabio Cannavaro', level: 1, clubs: ['Napoli', 'Parma', 'Inter Milan', 'Juventus', 'Real Madrid', 'Juventus', 'Al-Ahli'] },
  { id: 'alessandro-nesta', name: 'Alessandro Nesta', level: 1, clubs: ['Lazio', 'AC Milan', 'Montreal Impact', 'Chennaiyin FC'] },
  { id: 'gianluigi-buffon', name: 'Gianluigi Buffon', level: 1, clubs: ['Parma', 'Juventus', 'Paris Saint-Germain', 'Juventus', 'Parma'] },
  { id: 'ruud-gullit', name: 'Ruud Gullit', level: 1, clubs: ['Haarlem', 'Feyenoord', 'PSV Eindhoven', 'AC Milan', 'Sampdoria', 'Chelsea'] },
  { id: 'george-weah', name: 'George Weah', level: 1, clubs: ['Tonnerre Yaoundé', 'Monaco', 'Paris Saint-Germain', 'AC Milan', 'Chelsea', 'Manchester City', 'Marseille', 'Al Jazira'] },
  { id: 'davor-suker', name: 'Davor Suker', level: 2, clubs: ['Osijek', 'Dinamo Zagreb', 'Sevilla', 'Real Madrid', 'Arsenal', 'West Ham United', '1860 Munich'] },
  { id: 'dimitar-berbatov', name: 'Dimitar Berbatov', level: 3, clubs: ['CSKA Sofia', 'Bayer Leverkusen', 'Tottenham Hotspur', 'Manchester United', 'Fulham', 'Monaco', 'PAOK', 'Kerala Blasters'] },
  { id: 'emmanuel-adebayor', name: 'Emmanuel Adebayor', level: 3, clubs: ['Metz', 'Monaco', 'Arsenal', 'Manchester City', 'Real Madrid', 'Tottenham Hotspur', 'Crystal Palace', 'İstanbul Başakşehir', 'Kayserispor', 'Olimpia', 'Semassi'] },
  ...
  { id: 'kolo-toure', name: 'Kolo Toure', level: 3, clubs: ['ASEC Mimosas', 'Arsenal', 'Manchester City', 'Liverpool', 'Celtic'] },
  ...
  { id: 'jermain-defoe', name: 'Jermain Defoe', level: 4, clubs: ['West Ham United', 'Bournemouth', 'Tottenham Hotspur', 'Portsmouth', 'Tottenham Hotspur', 'Toronto FC', 'Sunderland', 'Bournemouth', 'Rangers', 'Sunderland'] },
  { id: 'bacary-sagna', name: 'Bacary Sagna', level: 4, clubs: ['Auxerre', 'Arsenal', 'Manchester City', 'Benevento', 'Montreal Impact'] },
  ...
  { id: 'darren-bent', name: 'Darren Bent', level: 4, clubs: ['Ipswich Town', 'Charlton Athletic', 'Tottenham Hotspur', 'Sunderland', 'Aston Villa', 'Fulham', 'Brighton & Hove Albion', 'Derby County', 'Burton Albion'] },
  ...
  { id: 'kevin-phillips', name: 'Kevin Phillips', level: 5, clubs: ['Baldock Town', 'Watford', 'Sunderland', 'Southampton', 'Aston Villa', 'West Bromwich Albion', 'Birmingham City', 'Blackpool', 'Crystal Palace', 'Leicester City'] },
  { id: 'kevin-davies', name: 'Kevin Davies', level: 5, clubs: ['Chesterfield', 'Southampton', 'Blackburn Rovers', 'Southampton', 'Millwall', 'Bolton Wanderers', 'Preston North End'] },
  { id: 'marlon-harewood', name: 'Marlon Harewood', level: 5, clubs: ['Nottingham Forest', 'Haka', 'Ipswich Town', 'West Ham United', 'Aston Villa', 'Newcastle United', 'Blackpool', 'Guangzhou R&F', 'Nottingham Forest', 'Bristol City', 'Hartlepool United', 'Nuneaton Town'] },
  { id: 'ricardo-fuller', name: 'Ricardo Fuller', level: 5, clubs: ['Tivoli Gardens', 'Crystal Palace', 'Tivoli Gardens', 'Heart of Midlothian', 'Preston North End', 'Portsmouth', 'Southampton', 'Stoke City', 'Charlton Athletic', 'Blackpool', 'Millwall', 'Oldham Athletic'] },
  { id: 'kenwyne-jones', name: 'Kenwyne Jones', level: 5, clubs: ['W Connection', 'Southampton', 'Sheffield Wednesday', 'Stoke City', 'Sunderland', 'Stoke City', 'Cardiff City', 'Bournemouth', 'Atlanta United'] },
  { id: 'grant-holt', name: 'Grant Holt', level: 5, clubs: ['Workington', 'Halifax Town', 'Sengkang Marine', 'Barrow', 'Sheffield Wednesday', 'Rochdale', 'Nottingham Forest', 'Shrewsbury Town', 'Norwich City', 'Wigan Athletic', 'Rochdale', 'Hibernian'] },
  { id: 'robert-earnshaw', name: 'Robert Earnshaw', level: 5, clubs: ['Cardiff City', 'West Bromwich Albion', 'Norwich City', 'Derby County', 'Nottingham Forest', 'Cardiff City', 'Maccabi Tel Aviv', 'Toronto FC', 'Blackpool', 'Chicago Fire', 'Vancouver Whitecaps'] },
  { id: 'michael-chopra', name: 'Michael Chopra', level: 5, clubs: ['Newcastle United', 'Watford', 'Nottingham Forest', 'Barnsley', 'Cardiff City', 'Sunderland', 'Cardiff City', 'Ipswich Town', 'Blackpool', 'Kerala Blasters', 'Alloa Athletic'] },
  { id: 'david-nugent', name: 'David Nugent', level: 5, clubs: ['Bury', 'Preston North End', 'Portsmouth', 'Burnley', 'Leicester City', 'Middlesbrough', 'Derby County', 'Preston North End', 'Tranmere Rovers'] },
  { id: 'jay-bothroyd', name: 'Jay Bothroyd', level: 5, clubs: ['Coventry City', 'Perugia', 'Blackburn Rovers', 'Charlton Athletic', 'Wolverhampton Wanderers', 'Stoke City', 'Cardiff City', 'Queens Park Rangers', 'Sheffield Wednesday', 'Muangthong United', 'Júbilo Iwata', 'Consadole Sapporo'] },
  { id: 'iker-casillas', name: 'Iker Casillas', level: 2, clubs: ['Real Madrid', 'Porto'], debutYear: 1999 },
  { id: 'petr-cech', name: 'Petr Cech', level: 2, clubs: ['Chmel Blšany', 'Sparta Prague', 'Rennes', 'Chelsea', 'Arsenal'] },
  { id: 'erling-haaland', name: 'Erling Haaland', level: 1, clubs: ['Bryne', 'Molde', 'Red Bull Salzburg', 'Borussia Dortmund', 'Manchester City'] },
  { id: 'kylian-mbappe', name: 'Kylian Mbappe', level: 1, clubs: ['Monaco', 'Paris Saint-Germain', 'Real Madrid'], debutYear: 2015 },
  { id: 'jude-bellingham', name: 'Jude Bellingham', level: 1, clubs: ['Birmingham City', 'Borussia Dortmund', 'Real Madrid'], debutYear: 2019 },
  ...
  { id: 'bukayo-saka', name: 'Bukayo Saka', level: 2, clubs: ['Arsenal'], debutYear: 2018 },
  { id: 'harry-kane', name: 'Harry Kane', level: 1, clubs: ['Tottenham Hotspur', 'Leyton Orient', 'Millwall', 'Norwich City', 'Leicester City', 'Bayern Munich'] },
